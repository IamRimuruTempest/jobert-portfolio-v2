...
export default function Footer() {
  return (
    <footer class=" w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto my-24">
      <div class="text-center">
        <div>
          <a
            class="flex-none text-xl font-semibold text-[#F0DB4F]"
            href="/"
            aria-label="Brand"
          >
        ...
        <div class="mt-3">
          <p class="text-white/70">jobertadviento.webdev@gmail.com</p>
          <p class="text-white/70">+63 950 7998 361</p>
        </div>
        ...
        <div class="mt-3 space-x-2">
          <a
            ...
            href="https://github.com/IamRimuruTempest "
          >
            <svg
          ...
          <a
            class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-white/70 hover:bg-[#F0DB4F] hover:text-black disabled:opacity-50 disabled:pointer-events-none "
            href="https://twitter.com/iamtreboj123"
          >
            <svg
              class="flex-shrink-0 size-3.5"
              xmlns="http://www.w3.org/2000/svg"
